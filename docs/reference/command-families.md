...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `rm` | destructive | all | dangerous | experimental_only | experimental-only (constrained executable fallback) | yes | no | `rm -i old.log` | `remove file`, `delete file` | — |
| `sudo` | privileged | all | dangerous | blocked | blocked (unavailable) | no | no | `sudo ls /var/root` | `run as root`, `elevated command` | — |
...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `cd` | navigation | all | safe | direct_only | direct-only (direct executable support only) | yes | no | `cd src` | `change directory`, `go to folder` | Changes the oterminus working directory for the current REPL session. |
| `du` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `du -h .` | `disk usage`, `folder size` | — |
| `file` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `file README.md` | `identify file type` | — |
| `find` | search | all | safe | structured | structured (normal executable support) | yes | no | `find . -name '*.py'` | `find files`, `search directories` | — |
| `ls` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `ls -la` | `list files`, `show directory contents` | — |
| `pwd` | navigation | all | safe | structured | structured (normal executable support) | yes | no | `pwd` | `where am i`, `print working directory` | — |
| `stat` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `stat README.md` | `file metadata`, `file info` | — |
...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `chmod` | permissions | all | write | structured | structured (normal executable support) | yes | no | `chmod 755 script.sh` | `change permissions`, `set file mode` | — |
| `chown` | permissions | all | dangerous | experimental_only | experimental-only (constrained executable fallback) | yes | no | `chown user:group file.txt` | `change file owner` | — |
| `cp` | filesystem_write | all | write | structured | structured (normal executable support) | yes | no | `cp notes.txt backup/notes.txt` | `copy file`, `duplicate file` | — |
| `mkdir` | filesystem_write | all | write | structured | structured (normal executable support) | yes | no | `mkdir -p logs/archive` | `create folder`, `make directory` | — |
| `mv` | filesystem_write | all | write | structured | structured (normal executable support) | yes | no | `mv report.md docs/` | `move file`, `rename file` | — |
| `touch` | filesystem_write | all | write | experimental_only | experimental-only (constrained executable fallback) | yes | no | `touch notes.txt` | `create empty file` | — |
...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `open` | macos_integration | darwin | safe | structured | structured (normal executable support) | yes | no | `open .` | `open in finder`, `reveal in finder` | Opens a local file or folder via macOS LaunchServices. |
...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `lsof` | process_inspection | all | safe | structured | structured (normal executable support) | yes | no | `lsof -p 1234` | `open files for process` | Lists open files and sockets; output can expose sensitive process or path information. |
| `pgrep` | process_inspection | all | safe | structured | structured (normal executable support) | yes | no | `pgrep -f python` | `find process by name` | — |
| `ps` | process_inspection | all | safe | structured | structured (normal executable support) | yes | no | `ps -A` | `show running processes` | — |
...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `clear` | system_inspection | all | safe | structured | structured (normal executable support) | yes | no | `clear` | `clear terminal`, `clear screen` | Clears the current terminal screen for a clean session view. |
| `df` | system_inspection | all | safe | structured | structured (normal executable support) | yes | no | `df -h` | `disk space` | — |
| `env` | system_inspection | all | safe | structured | structured (normal executable support) | yes | no | `env PATH` | `environment variable` | Printing the full environment may include sensitive values; curated mode only allows single-variable lookups. |
| `uname` | system_inspection | all | safe | structured | structured (normal executable support) | yes | no | `uname -a` | `system name`, `kernel info` | — |
| `which` | system_inspection | all | safe | structured | structured (normal executable support) | yes | no | `which python3` | `find executable` | — |
| `whoami` | system_inspection | all | safe | structured | structured (normal executable support) | yes | no | `whoami` | `current user` | — |
...
| Command | Category | Platforms | Risk | Maturity | Status | Direct support | Network | Examples | Natural-language aliases | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| `cat` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `cat README.md` | `show file contents`, `print file` | — |
| `grep` | search | all | safe | structured | structured (normal executable support) | yes | no | `grep -n TODO src/main.py` | `search text`, `find matching lines` | — |
| `head` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `head -n 20 README.md` | `first lines` | — |
| `sort` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `sort -u names.txt` | `sort lines` | — |
| `tail` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `tail -n 50 app.log` | `last lines` | — |
| `uniq` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `uniq -c names.txt` | `dedupe lines`, `unique lines` | — |
| `wc` | inspection | all | safe | structured | structured (normal executable support) | yes | no | `wc -l README.md` | `count lines`, `count words` | — |
